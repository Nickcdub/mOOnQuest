...
public class Maze {
    ...
    //This will be used by the generate method to remove walls between adjacent cells
    private void removeWalls(final Region theCurrent, final Region theNext){
        //Check if theNext is to the left of theCurrent
        if(theCurrent.col-theNext.col == 1){
            theCurrent.walls[0] = false;
            theNext.walls[1] = false;
        }else if(theCurrent.col-theNext.col == -1){ //Check if theNext is to the right of theCurrent
            theNext.walls[0] = false;
            theCurrent.walls[1] = false;
        }else if(theCurrent.row-theNext.row == 1){ //Check if theNext is above theCurrent
            theCurrent.walls[2] = false;
            theNext.walls[3] = false;
        }else if(theCurrent.row-theNext.row == -1){ //Check if theNext is below theCurrent
    ...
    //This method will be used by randomNeighbor within Region in order to find index regions within grid
    ...
    public class Region {
        ...
        Region(final int i, final int j) {
            row = i;
            col = j;
        ...
        //This randomNeighbor method will give generator a random region to mark as next
